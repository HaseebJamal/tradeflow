...
class SubscriptionChangeRequest extends Model
{
    protected $fillable = [
        ...
        'type', 'billing_cycle', 'expected_amount', 'payment_method', 'trial_eligible', 'trial_days',
        'starts_at', 'ends_at', 'effective_at', 'note', 'admin_note', 'status', 'reviewed_at', 'reviewed_by',
    ];

    protected $casts = ['reviewed_at' => 'datetime', 'trial_eligible' => 'boolean', 'starts_at' => 'date', 'ends_at' => 'date', 'effective_at' => 'date'];
