    ...
    public static function defaults(string $role): array
    {
        return match ($role) {
            'business_admin' => [
                ...
                'orders.view', 'orders.create', 'orders.edit', 'orders.update_status', 'orders.assign_delivery',
                'payments.view', 'payments.create', 'accounting.view',
            ...
            'sales_staff' => [
                ...
                'orders.view', 'orders.create', 'payments.view', 'invoices.view', 'invoices.print',
            ],
            'inventory_staff' => [
            ...
            'accountant' => [
                'dashboard.view', 'payments.view', 'payments.create', 'accounting.view',
