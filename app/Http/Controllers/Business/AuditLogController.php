...
class AuditLogController extends Controller
{
    ...
    private function filteredQuery(Request $request): array
    {
        ...
        $query = $this->businessLogs()
            ->select(['id', 'user_id', 'user_name', 'role', 'actor_role', 'business_id', 'module', 'action', 'description', 'route', 'record_type', 'record_id', 'old_values', 'new_values', 'user_agent', 'ip_address', 'occurred_at', 'created_at'])
            ->with('user:id,name')
