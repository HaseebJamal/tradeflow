...
class BusinessActionPermissionMiddleware
{
    ...
    private function permissionFor(?string $route): ?string
    {
        return match ($route) {
            ...
            'business.products.labels.preview' => 'products.view',
            ...
            'business.inventory.purchase-suggestions.index' => 'inventory.view',
            'business.inventory.purchase-suggestions.settings', 'business.inventory.purchase-suggestions.settings.update' => 'inventory.low_stock_alerts',
            'business.inventory.batches.index' => 'inventory.view',
            'business.inventory.batches.opening-allocation' => 'inventory.adjust_stock',
            'business.inventory.stock-counts.index', 'business.inventory.stock-counts.show' => 'inventory.view',
            'business.inventory.stock-counts.create', 'business.inventory.stock-counts.edit', 'business.inventory.stock-counts.update',
            'business.inventory.stock-counts.items.store', 'business.inventory.stock-counts.start', 'business.inventory.stock-counts.finalize',
            'business.inventory.stock-counts.cancel' => 'inventory.adjust_stock',
            ...
            'business.customers.balance-adjustments.store', 'business.customers.balance-adjustments.reverse' => 'customers.adjust_balance',
            ...
            'business.suppliers.balance-adjustments.store', 'business.suppliers.balance-adjustments.reverse' => 'suppliers.adjust_balance',
            'business.purchases.index', 'business.purchases.show' => 'purchases.view', 'business.purchases.create', 'business.purchases.from-suggestions', 'business.purchases.store' => 'purchases.create',
            ...
            'business.pos.register.history', 'business.pos.register.reconciliation' => 'pos.close_register',
            ...
            'business.reports.end-of-day' => 'reports.view',
            'business.reports.end-of-day.pdf' => 'reports.export',
            'business.reports.stock-movement-analytics' => 'reports.view',
            'business.reports.stock-movement-analytics.pdf' => 'reports.export',
            'business.reports.product-performance', 'business.reports.product-performance.show' => 'reports.view',
            'business.reports.product-performance.pdf' => 'reports.export',
