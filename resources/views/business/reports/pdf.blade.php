...
@if($showProfitability)
    ...
    <table class="summary-grid"><tr><td><span class="summary-label">Net Sales</span><span class="summary-value">{{ $money($summary['net_sales']) }}</span></td><td><span class="summary-label">COGS</span><span class="summary-value">{{ $money($summary['cogs']) }}</span></td><td><span class="summary-label">Gross Profit</span><span class="summary-value">{{ $money($summary['gross_profit']) }}</span></td></tr><tr><td><span class="summary-label">Operating Expenses</span><span class="summary-value">{{ $money($summary['expenses']) }}</span></td><td><span class="summary-label">Net Profit / Loss</span><span class="summary-value">{{ $money($summary['net_profit']) }}</span></td><td><span class="summary-label">Sales Returns</span><span class="summary-value">{{ $money($summary['sales_returns']) }}</span></td></tr></table>
@endif
