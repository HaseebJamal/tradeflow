...
<div class="row g-4"><div class="col-lg-8">
    ...
    <div class="tf-card p-4 mb-4"><h2 class="h5">Purchase summary</h2><dl class="row mb-0"><dt class="col-7">Grand total</dt><dd class="col-5 text-end">Rs {{ number_format($purchase->grand_total, 2) }}</dd><dt class="col-7">Paid amount</dt><dd class="col-5 text-end">Rs {{ number_format($purchase->paid_amount, 2) }}</dd><dt class="col-7">Remaining payable</dt><dd class="col-5 text-end">Rs {{ number_format($purchase->balance, 2) }}</dd><dt class="col-7">Payment method</dt><dd class="col-5 text-end">{{ $purchase->payment_method ?: $purchase->latestPayment?->method ?: ((float) $purchase->paid_amount > 0 ? 'Payment recorded' : 'Not paid') }}</dd></dl></div>
