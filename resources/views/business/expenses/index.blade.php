...
<div class="row g-3 mb-4">
    <div class="col-md-4"><div class="tf-card p-4"><div class="tf-muted">Total Expenses After Filters</div><div class="h3 fw-bold">Rs {{ number_format($totalExpenses ?? 0) }}</div></div></div>
