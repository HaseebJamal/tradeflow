...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quantityLabel = value => { const number = Number(value || 0); if (!Number.isFinite(number)) return '0'; const normalized = String(Math.round(number * 1000) / 1000); return normalized.includes('.') ? normalized.replace(/0+$/, '').replace(/\.$/, '') : normalized; };
