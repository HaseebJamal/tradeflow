...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
    <div class="d-flex align-items-center gap-2"><span class="badge text-bg-danger" data-live-indicator>Live</span><span class="small tf-muted" data-live-label>Refreshing every second</span><small class="tf-muted">Current time: {{ now()->timezone(config('app.timezone'))->format('d M, Y h:i A') }}</small></div>
