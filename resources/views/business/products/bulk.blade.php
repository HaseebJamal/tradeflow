                ...
                <tbody>
                    @for($i=0;$i<3;$i++)
                        <tr data-bulk-row>
                            ...
                            <td><input name="products[{{ $i }}][wholesale_price]" type="number" step="0.01" min="0" class="form-control" required data-selling-price="wholesale_price"></td>
                            <td><input name="products[{{ $i }}][retail_price]" type="number" step="0.01" min="0" class="form-control" required data-selling-price="retail_price"></td>
