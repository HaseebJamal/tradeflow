    ...
    <div class="tf-demo-contact-grid">
        <section class="tf-card tf-settings-feature-card p-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-7 d-none" data-demo-source-panel="upload"><label class="form-label" for="demoVideoFile">Upload demo video</label><div class="tf-file-upload"><input id="demoVideoFile" name="demo_video_file" type="file" class="visually-hidden @error('demo_video_file') is-invalid @enderror" accept="video/mp4,video/webm,video/ogg,.mp4,.webm,.ogv" data-tf-file-upload><label for="demoVideoFile" class="tf-file-upload__control"><i class="bi bi-cloud-arrow-up"></i><span><strong>Choose demo video</strong><small>MP4, WebM, or OGV up to 40 MB</small></span><em data-tf-file-upload-name>No file selected</em></label></div>@error('demo_video_file')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror</div>
