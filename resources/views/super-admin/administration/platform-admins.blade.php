...
<td>@if($admin->profile_image)<img src="{{ asset('storage/'.$admin->profile_image) }}" class="navbar-avatar">@else<i class="bi bi-person-circle h4"></i>@endif</td>
