...
<section class="tf-section" style="padding-top:140px">
    <div class="container">
        <div class="mb-5"><span class="tf-badge tf-badge-info">Trust Center</span><h1 class="fw-bold mt-3">Privacy & Security</h1><p class="tf-muted">TradeFlow is built for secure multi-business wholesale operations with local/manual records.</p></div>
        <div class="row g-4">
            @foreach([
                ...
                ['No Paid API Dependency','TradeFlow does not connect to JazzCash, Easypaisa, WhatsApp, SMS, Google Maps, or payment gateway APIs in this MVP.'],
            ] as [$title,$text])
