...
<style>
    ...
    .tf-thermal-document { box-sizing: border-box; min-width: 0; overflow: visible !important; width: 100%; max-width: {{ $contentWidth }}mm; margin: {{ $pdf ? '0' : '1rem auto' }}; padding: 0; background: #fff; color: #111; font-family: DejaVu Sans, Arial, Helvetica, sans-serif; font-size: {{ $fontSize }}; line-height: 1.35; }
    ...
    .tf-thermal-document__muted { color: #4b5563; max-width: 100%; overflow: visible !important; overflow-wrap: anywhere; white-space: normal; word-break: break-word; }
    .tf-thermal-document__rule { border: 0; border-top: 1px dashed #555; margin: 3mm 0; }
    .tf-thermal-document__row { display: table; page-break-inside: avoid; width: 100%; table-layout: fixed; margin: 1mm 0; }
    .tf-thermal-document__label, .tf-thermal-document__value { display: table-cell; overflow: visible !important; overflow-wrap: anywhere; vertical-align: top; white-space: normal; word-break: break-word; word-wrap: break-word; }
    ...
    .tf-thermal-document__item-calculation, .tf-thermal-document__item-amount { display: table-cell; overflow: visible !important; vertical-align: top; white-space: normal; word-break: break-word; }
    .tf-thermal-document__item-calculation { overflow-wrap: anywhere; padding-right: 1mm; width: 60%; word-wrap: break-word; }
    .tf-thermal-document__item-amount { overflow-wrap: anywhere; text-align: right; width: 40%; word-wrap: break-word; }
...
<style media="screen">
    ...
    .tf-thermal-document__item-calculation { width: 60%; padding-right: .5rem; }
    .tf-thermal-document__item-amount { width: 40%; }
...
<style media="print">
    ...
    .tf-thermal-document { left: 0; margin: 0; max-width: none; overflow: visible !important; padding: 0; position: absolute; top: 0; width: 100%; }
</style>
@endif
