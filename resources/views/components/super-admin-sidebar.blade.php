<div class="tf-sidebar-inner p-3" data-super-admin-sidebar>
    ...
    <nav class="d-grid gap-1">
        ...
        <a href="{{ route('admin.notifications.index') }}" class="{{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}" title="Notifications"><i class="bi bi-bell"></i><span class="tf-sidebar-text">Notifications</span></a>
    </nav>
</div>
